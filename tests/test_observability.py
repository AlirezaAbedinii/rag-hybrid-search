"""Tests for the observability cost/latency helpers (deterministic, no network).

(These were previously in test_metrics.py; that name now holds the eval-metric
tests per the plan, so the observability helpers live here.)
"""
